...
const page = () => {
  return (
    <div>
      ...
      >
        <h1 className="text-center text-2xl md:text-5xl font-bold text-tertiary mb-8">
          Top-Rated Brownstone Restoration Experts in NYC – Quality
          Craftsmanship You Can Trust
        </h1>
        <h2 className="text-center text-xl md:text-3xl font-bold text-tertiary mb-8">
          Your Premier Choice for Brownstone Restoration in Brooklyn, Manhattan,
          Queens, and The Bronx
        </h2>
        <p className="text-lg">
          When it comes to brownstone restoration, residents across New York
          City rely on one trusted name—Infinity Construction NYC. As a premier
          provider of full-service restoration, we offer end-to-end solutions
          tailored to meet the unique demands of brownstone architecture. From
          brownstone restoration Brooklyn NY to brownstone façade restoration
          Bronx, our work reflects timeless beauty, integrity, and lasting
          durability.
        </p>
        <p>
          We understand the historical significance of brownstones and the pride
          homeowners take in maintaining their architectural charm. That’s why
          every service we provide—from brownstone masonry repair Manhattan to
          brownstone stoop repair Brooklyn—is delivered with exceptional
          attention to detail, craftsmanship, and client satisfaction.
        </p>
        <h2 className="text-left text-xl md:text-3xl font-bold text-tertiary my-8">
        ...
        <p className="text-lg">
          ...
          expertise to deliver flawless results.
        </p>{" "}
        <br />
        ...
        restore your home’s curb appeal and ensure long-term stability. We match
        original materials to preserve authenticity. <br />
        <strong>Stoop and Step Repair</strong> <br />
        Stoops and entry steps often bear the brunt of foot traffic and weather.
        Our brownstone stoop repair Brooklyn and brownstone stoop restoration
        Manhattan services replace cracked, damaged, or missing stones with
        seamless precision. <br />
        <strong>Masonry and Structural Repair</strong>
        <br />
        We provide structural support, wall reinforcement, and brownstone
        masonry repair Manhattan that keeps your home solid from the inside out.
        We handle lintel replacements, cornice work, and re-pointing with care.{" "}
        <br />
        <strong>Waterproofing and Sealing</strong>
        <br />
        Moisture is the enemy of any masonry building. Our brownstone
        waterproofing Bronx NY services involve professional sealing techniques
        to prevent leaks, stains, and foundational issues. <br />
        ...
        <ul className="list-disc list-inside mt-4 space-y-1">
          ...
          <li>Clear timelines and project plans</li>
          <li>Transparent, itemized pricing</li>
          <li>Expert consultation and material guidance</li>
        ...
        <ul className="list-disc list-inside mt-4 space-y-1">
          <li>Brownstone patch repair Manhattan</li>
          <li>Brownstone façade restoration Bronx</li>
          <li>Brownstone steps repair Queens</li>
          <li>Brownstone window trim repair Brooklyn</li>
          <li>Brownstone cornice repair Brooklyn</li>
          <li>Brownstone exterior paint Bronx</li>
          <li>Brownstone waterproofing Bronx NY</li>
        </ul>
        <p>
        ...
        <ul className="list-disc list-inside mt-4 space-y-1">
          <li>Homeowners restoring family properties</li>
          <li>Landlords preserving income properties</li>
          <li>Developers enhancing resale value</li>
          <li>Historic district property owners complying with regulations</li>
        </ul>
        <h2 className="text-left text-xl md:text-3xl font-bold text-tertiary my-8">
        ...
        <p>• Budget-Conscious Options: No surprise costs or hidden fees.</p>
        <p>
