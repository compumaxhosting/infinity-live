            ...
            <div className="w-full lg:w-8/12 p-4 space-y-6">
              ...
              >
                ...
                >
                  ...
                  <span itemProp="description">
                    We remove debris, damaged shingles, and deteriorating wood.
                    The roof base is meticulously cleaned and prepared to ensure
                    optimal adhesion and performance of the new materials.
                  </span>
                </li>
                <li
                  className="text-justify"
                ...
                >
                  •{" "}
                  <strong>Quality Control Inspection and Documentation:</strong>{" "}
                  <span itemProp="description">
                    Before finalizing the project, we conduct a comprehensive
                    quality control inspection to ensure all work meets our high
                    standards. Detailed documentation is provided for your
          ...
          <ul itemProp="review" itemScope itemType="https://schema.org/Review">
            ...
            >
              ...
              <li className="text-justify" itemProp="reviewBody">
                ...
                team is trained to handle even the most complex roof restoration
                projects, ensuring exceptional workmanship and results.
              </li>
              <li className="text-justify" itemProp="reviewBody">
