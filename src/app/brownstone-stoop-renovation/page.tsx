...
const BrownstoneStoopRenovationPage = () => {
  return (
    <div>
      <HeaderSpecial />
      <main className="container mx-auto pt-6 sm:pt-36 md:pt-44 pb-12 text-base sm:text-lg leading-relaxed">
        {/* Hero Heading */}
        ...
        {/* Intro Section */}
        <section className="space-y-4 px-4 md:px-12 lg:px-48">
          <p>
        ...
        {/* Why Choose Us */}
        <section className="my-10 flex flex-col lg:flex-row items-center gap-8 px-4 md:px-12 lg:px-48">
          {/* Bullet Points */}
        ...
        {/* Services List */}
        <section className="my-10 space-y-6 px-4 md:px-12 lg:px-48">
          ...
          <ul className="list-disc ml-6 space-y-2">
            ...
            <li>Bronx:Skilled stoop masonry contractors and repair services</li>
          </ul>
          <p>
