  ...
  return (
    <>
      ...
      <div>
        <HeaderSpecial />
        <main
          className="container mx-auto p-4 pt-40 sm:pt-48 2xl:pt-36 border-b text-xl md:text-2xl px-4 md:px-12 lg:px-48"
          style={{ fontFamily: "var(--font-forum)" }}
        >
          <header>
            <h1 className="text-center text-4xl sm:text-5xl lg:text-6xl  text-tertiary dark:text-white mb-8">
          ...
          <section className="flex flex-col lg:flex-row justify-center items-center gap-8 mb-8">
            <article className="w-full p-4 space-y-6">
              <h2 className="text-4xl md:text-5xl my-4">Our Concrete Paving Services</h2>
              <ul>
                <li className="text-justify text-xl md:text-2xl text-slate-800">
          ...
          <section className="mb-8">
            <p className="text-justify text-xl md:text-2xl text-slate-800">
            ...
            <h2 className="text-4xl md:text-5xl my-4">Our Natural Stone Paving Services</h2>
            <ul>
              <li className="text-justify text-xl md:text-2xl text-slate-800">
          ...
          <section className="mb-8">
            ...
            <h2 className="text-4xl md:text-5xl my-4">Our Brick Paving Services</h2>
            <ul>
              <li className="text-justify text-xl md:text-2xl text-slate-800">
