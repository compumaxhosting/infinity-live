      ...
      >
        ...
        <section itemScope itemType="https://schema.org/LocalBusiness">
          ...
          >
            ...
            >
              ...
              <span itemProp="description">
                ...
                fresh mortar to restore the strength, stability, and durability
                of your brickwork.
              </span>
            </li>
            <li
          ...
          <p className="text-justify" itemProp="description">
            ...
            enhancement, our team is dedicated to delivering exceptional results
        ...
        <section>
          ...
          <h2 className="text-4xl my-4">Our Waterproofing Services Include:</h2>
          <ul
            itemProp="hasOfferCatalog"
            itemScope
            itemType="https://schema.org/OfferCatalog"
          >
            ...
            >
              ...
              <span itemProp="description">
                We install drainage solutions to redirect water away from brick
                surfaces, reducing the risk of damage.
              </span>
            </li>
            <li
              className="text-justify"
            ...
            >
              ...
              <span itemProp="description">
                To protect your masonry from harsh weather conditions, we apply
                coatings designed to withstand freeze-thaw cycles and prevent
