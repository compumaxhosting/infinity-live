  ...
  return (
    <>
      ...
      <div itemScope itemType="https://schema.org/Service">
        ...
        >
          <h1
            className="text-center text-4xl sm:text-5xl lg:text-6xl text-gra-900 dark:text-white mb-8"
            itemProp="name"
          >
          ...
          <section className="px-4 md:px-16 lg:px-40" itemScope itemType="https://schema.org/LocalBusiness">
            <div className="flex flex-col lg:flex-row items-center gap-6">
              ...
              <div className="flex flex-col gap-4">
                ...
                <p className="text-xl md:text-2xl text-slate-800 text-justify" itemProp="description">
