...
export const metadata = {
  ...
  keywords:
    "Infinity Construction NYC, brownstone restoration NYC, masonry services NYC, waterproofing NYC, roof restoration NYC, NYC masonry contractor, exterior renovation NYC, brick pointing NYC, Brooklyn construction company, NYC roofing contractors",
  openGraph: {
    title: "Infinity Construction NYC – Full Sitemap & Services",
    description:
      "Discover the full sitemap of Infinity Construction NYC — access all pages covering brownstone restoration, masonry, roofing, waterproofing, and contact info.",
