      ...
      <section className="flex justify-center items-center bg-white dark:bg-slate-950 p-6 pt-0 pb-6 sm:pb-20">
        <div className="max-w-7xl w-full">
          ...
          <p
            ...
            style={{ fontFamily: "var(--font-forum)" }}
          >
            As experts in painting and masonry , we provide a full suite of
            restoration services that preserve the historical appeal of your
            property while strengthening its structure. Our skilled team brings
            unmatched craftsmanship and attention to detail to every project,
            whether it’s restoring facades or revitalizing structural elements.
          </p>
