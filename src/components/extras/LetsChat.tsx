  ...
  return (
    <div>
      ...
      <button
        ...
        onClick={toggleChat}
        className="flex fixed z-10 bottom-16 right-6 bg-secondary text-white p-4 px-4 sm:px-8 md:px-10 rounded-full shadow-lg items-center space-x-2 hover:bg-stone-900 transition-all duration-300"
      >
