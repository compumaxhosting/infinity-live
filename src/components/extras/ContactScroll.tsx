  ...
  return (
    <Link href="" to="contact-us" smooth={true} duration={1000}>
      <button
        ...
        className="fixed z-10 bottom-16 left-6 bg-primary text-white p-3 px-3 sm:px-8 md:px-10 rounded-full shadow-lg flex items-center space-x-2 hover:bg-stone-900 transition-all duration-300"
      >
