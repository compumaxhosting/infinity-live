    ...
    <section className="py-16 md:py-24 bg-white">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-12">
        ...
        <div className="max-w-3xl mx-auto mb-12">
          <Accordion type="single" collapsible className="space-y-4">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="text-xl md:text-2xl font-semibold text-gray-900 hover:text-orange-600 transition duration-200 py-4">
                  {faq.question}
                </AccordionTrigger>
                <AccordionContent className="text-lg leading-7 text-gray-700 pb-4">
                  {faq.answer}
                </AccordionContent>
              </AccordionItem>
            ))}
        ...
        <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg p-8 md:p-12 text-center">
          ...
          <p className="text-lg leading-7 text-gray-700 mb-8 max-w-2xl mx-auto">
