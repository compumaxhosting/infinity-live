    ...
    sections: [
      {
        ...
        paragraph: (
          <>
            Historic brownstones in NYC offer timeless appeal, yet many were
            built long before modern energy standards. Upgrading these
            properties can:
            <ul className="list-disc ml-6 mt-2">
              <li>Lower monthly energy bills</li>
              <li>Improve indoor comfort year-round</li>
              <li>Reduce environmental impact</li>
              <li>Maintain property value in landmark districts</li>
            </ul>
            Whether you’re in Brooklyn Heights or the Upper West Side, careful
            planning is key.
          </>
        ),
      },
      {
        title: "Top Sustainable Upgrades That Work",
        paragraph: (
          <>
            <p className="mt-3">1. Insulation Improvements</p>
            <p>
              Older walls often lack proper insulation. Upgrading attic,
              basement, and wall insulation helps stabilize indoor temperatures
              and cuts heating costs dramatically — essential in NYC winters.
            </p>

            <p className="mt-3">2. High-Efficiency Windows</p>
            <p>
              Replacing or retrofitting windows with energy-efficient options
              reduces drafts without sacrificing classic aesthetics. Choose
              designs that mimic original styles to meet local preservation
              rules.
            </p>

            <p className="mt-3">3. Smart HVAC Systems</p>
            <p>
              Modern heating, ventilation, and air conditioning systems offer
              better control and lower energy use. Pair with smart thermostats
              to optimize performance during peak and off-peak hours.
            </p>

            <p className="mt-3">4. Sustainable Lighting</p>
            <p>
              Switching to LED lighting throughout the home reduces energy use
              and extends bulb life — a small change that adds up.
            </p>

            <p className="mt-3">5. Green Roofing Solutions</p>
            <p>
              Installing green roofs or reflective materials can lower heat
              absorption during summer months and contribute to urban
              environmental goals.
            </p>
          </>
        ),
      ...
      {
        title: "Balancing Sustainability with Historic Preservation",
        paragraph: (
          <>
            Renovating a landmark property demands expertise. Work with
            experienced professionals like those at{" "}
            <Link href="/" className="text-blue-500">
              Infinity Construction NYC
            </Link>{" "}
            , who specialize in renovations that honor architectural history.
            <p className="mt-3">
              For homes within designated historic districts, consult resources
              for compliance, such as the guidelines available from{" "}
              <Link href="/" className="text-blue-500">
      ...
      },
      {
        ...
        paragraph: (
          <>
            Sustainable upgrades boost comfort, efficiency, and long-term value
            for historic brownstones throughout New York City. By combining
            energy-saving improvements with preservation-sensitive techniques,
            homeowners can enjoy the best of both worlds — a greener home
      ...
      },
      {
        ...
        paragraph: (
          <>
            ...
            <Link href="/" className="text-blue-500">
              brownstone stoop restoration in NYC
            </Link>{" "}
            ensures all filings and approvals are handled correctly and
            efficiently.
          </>
        ),
      },
