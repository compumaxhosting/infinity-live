const projectData = [
  {
    id: 1,
    title: "Brownstone Stoop Renovation",
    date: "JULY 15, 2021",
    description:
  ...
  },
  {
    ...
    date: "MAY 25, 2020",
    description:
      "This project involved a lot of patience and perfection from our workers. We use vacuum-connected grinder machines to clean the gaps between the bricks to maintain a dust-free work environment. This exemplifies the quality of our work and the stability of the process we do by not damaging a single brick during the process of this job; while protecting our environment by using environmentally friendly products. Later, we fill the gap with waterproof cement to seal the bricks from future water damage.",
    image: "/project-img-5.webp",
    path: "/brick-pointing",
  },
];
